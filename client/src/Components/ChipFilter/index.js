      ...
      <div id="chip-section-container">
        <div className="chip-section">
          ...
          <div id="chip-container">
            {this.props.zone_chips
              ? this.props.zone_chips.map((chip, i) => {
                  return (
                    <Chip
                      key={i}
                      variant="outlined"
                      ...
                      label={chip.label}
                      onDelete={() => {
                        this.props.handleDeleteChip(chip, 'zone');
                      }}
                      className="chip"
                      color="primary"
                    />
        ...
        <div className="chip-section">
          ...
          <div id="chip-container">
            {this.props.use_chips
              ? this.props.use_chips.map((chip, i) => {
                  return (
                    <Chip
                      key={i}
                      variant="outlined"
                      ...
                      label={chip.label}
                      onDelete={() => {
                        this.props.handleDeleteChip(chip, 'use');
                      }}
                      className="chip"
                      color="primary"
                    />
